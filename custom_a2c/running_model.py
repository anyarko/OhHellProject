...
checkpoint_callback = CheckpointCallback(save_freq=204800, save_path='./logs/logs_a2c/500_350/',
                                         name_prefix='training')

'''A second callback that evaluates the saved models and saves the best one 
in a seperate folder'''
eval_callback = EvalCallback(eval_env, best_model_save_path='./logs/logs_a2c/500_350/best_model',
                             log_path='./logs/logs_a2c/500_350/', eval_freq=1024000,
...
model = A2C('MlpPolicy', env, policy_kwargs=policy_kwargs, tensorboard_log="./tmp/", 
             verbose=1)
