from rlcard.games.ohhell.dealer import OhHellDealer as Dealer
...
from rlcard.games.ohhell.player import PlayerStatus
from rlcard.games.ohhell.round import OhHellRound as Round
