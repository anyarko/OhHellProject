...
#         for i in range(10):
#             state = env.reset()
#             agent_num = env.game.current_player
#             current_p = env.game.players[agent_num].name
#             message = 'Starting player is not training agent?!'
#             assert current_p == 'Training', message
        
#         state = env.reset()
#         while not env.game.is_over():
#             current_p = env.game.players[env.game.current_player].name
#             message = 'You are not using the training agent!'
#             assert current_p == 'Training', message
